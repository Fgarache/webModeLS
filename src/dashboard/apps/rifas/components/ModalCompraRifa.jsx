        ...
        <div className="rifa-form-grid">
          <div className="form-group rifa-contact-group">
            ...
            <div className="rifa-contact-inline-row">
              ...
              <div className="rifa-channel-row" role="group" aria-label={purchaseModal.fields.channel}>
                {purchaseModal.channelOptions.map((option) => {
                  ...
                  return (
                    <button
                      key={option.value}
                      type="button"
                      className={`rifa-channel-button ${form.canal === option.value ? 'active' : ''}`}
                      onClick={() => onChange('canal', option.value)}
                      disabled={saving}
                      title={option.label}
