...
function Home({ config, onNavigate }) {
  ...
  const homeStyle = {
    ...
    '--home-bg-blur': resolvedConfig.visual.backgroundImageBlur,
    '--home-bg-filter': resolvedConfig.visual.backgroundImageFilter,
    '--home-hero-backdrop-blur': resolvedConfig.visual.heroBackdropBlur,
    '--home-glass-card-backdrop-blur': resolvedConfig.visual.glassCardBackdropBlur,
