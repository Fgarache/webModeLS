const homeConfig = {
  ...
  visual: {
    ...
    backgroundImageBlur: '0.5px',
    backgroundImageFilter: 'brightness(1) saturate(1.15)',
    heroBackdropBlur: '0px',
    glassCardBackdropBlur: '0px',
    mutedTextOpacity: 0.84,
    glassOpacity: 0.0,
    glassCardOpacity: 0.06,
    borderOpacity: 0.8,
    heroAccentOpacity: 0.06,
    heroSurfaceStartOpacity: 0.42,
    heroSurfaceEndOpacity: 0.1,
  },
};
